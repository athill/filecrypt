...
def main():
    ...
    #     print('Usage: encrypt <defn-file>, decrypt <defn-file>')
    #     exit() 

    parser = argparse.ArgumentParser(prog='filecrypt', description='Encrypt and decrypt files')
        ...
        if args.output_file == None:
            ...
            if args.output_file == args.file:
                ...
                if answer != 'y':
                    ...
                    import uuid
                    tmpfile = os.path.join(rootdir, 'tmp', uuid.uuid4())
